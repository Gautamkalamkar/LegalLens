...
class _FamilyPageState extends State<FamilyPage> {
  ...
  List<Map<dynamic, dynamic>> families = [];
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return DocumentView(
                ...
                docType: 'families',
                onDelete: () {
                  _hiveService.deletekey(index, families, box, 'families');
                  setState(() {});
                });
          },
        ),
        ...
        child: FittedBox(
          child: FloatingActionButton(
            onPressed: () async {
              ...
              if (!_hiveService.isDuplicate(file.name.trim(), families)) {
                families.add({
                  'name': file.name.trim(),
                  'path': file.path,
                  'text': text
                });
                box.put('families', families);
